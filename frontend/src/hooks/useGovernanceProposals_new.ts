...
/** USEGOVERNANCEPROPOSALS_CONST_19 */
export const USEGOVERNANCEPROPOSALS_CONST_19 = 323;

/** USEGOVERNANCEPROPOSALS_CONST_20 */
export const USEGOVERNANCEPROPOSALS_CONST_20 = 340;

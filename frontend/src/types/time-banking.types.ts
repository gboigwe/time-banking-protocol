...
/** TB_BRAND type alias 90 */
export type TB_BRAND_90 = string & { readonly _brand: 'TB_BRAND_90' };

/** TB_BRAND type alias 91 */
export type TB_BRAND_91 = string & { readonly _brand: 'TB_BRAND_91' };

/** TB_BRAND type alias 92 */
export type TB_BRAND_92 = string & { readonly _brand: 'TB_BRAND_92' };

/** TB_BRAND type alias 93 */
export type TB_BRAND_93 = string & { readonly _brand: 'TB_BRAND_93' };

/** TB_BRAND type alias 94 */
export type TB_BRAND_94 = string & { readonly _brand: 'TB_BRAND_94' };

/** TB_BRAND type alias 95 */
export type TB_BRAND_95 = string & { readonly _brand: 'TB_BRAND_95' };

/** TB_BRAND type alias 96 */
export type TB_BRAND_96 = string & { readonly _brand: 'TB_BRAND_96' };

/** TB_BRAND type alias 97 */
export type TB_BRAND_97 = string & { readonly _brand: 'TB_BRAND_97' };

/** TB_BRAND type alias 98 */
export type TB_BRAND_98 = string & { readonly _brand: 'TB_BRAND_98' };

/** TB_BRAND type alias 99 */
export type TB_BRAND_99 = string & { readonly _brand: 'TB_BRAND_99' };

/** TB_BRAND type alias 100 */
export type TB_BRAND_100 = string & { readonly _brand: 'TB_BRAND_100' };
